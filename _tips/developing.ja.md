...
例えば `<html lang="en">` のように　`html`　タグで `lang` . Use the `lang` 属性を使うことで､すべてのページの主要言語を示します｡要素の言語がページの他の部分と異なる場合､特定の要素でlang属性を使います｡
...
* CAPTCHAを解く2つ以上の方法を提供すること｡
* CAPTCHAを迂回できる人間の担当者へのアクセスを提供すること｡
* ユーザー認証にCAPTCHAを要求しないこと｡
