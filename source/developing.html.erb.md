...
<div class="non-standard">
  <figure>
    ...
    <% html_example do %>
      ...
      <div class="slider">
        <button id="slider-control" class="slider-control"  role="slider" aria-valuetext="0" aria-valuenow="0" aria-valuemax="10" aria-valuemin="0" aria-labelledby="slider-label" tabindex="0"></button>
      </div>
